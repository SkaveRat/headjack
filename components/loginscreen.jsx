                ...
                <form onSubmit={this.handleLogin}>
                    <div className="form-group row">
                        ...
                        <div className="col-xs-6">
                            <input type="text" className="form-control" id="user_id" placeholder="@bob:matrix.org" defaultValue={user_id} onChange={this.handleUserId} />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label className="col-sm-3 form-control-label" htmlFor="inputPassword3">Password</label>
                        <div className="col-xs-6">
                            <input type="password" className="form-control" id="inputPassword3" placeholder="Password" defaultValue={password} onChange={this.handlePassword} />
                        </div>
                    </div>
                    <div className="form-group row">
